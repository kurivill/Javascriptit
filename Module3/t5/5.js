...
for (let i = 0; i < picArray.length; i++) {
  let otsikko2elementti = document.createElement('h2')
  let otsikko2 = document.createTextNode(picArray[i].title)


  let figuuri = document.createElement('figure')

  let image = document.createElement('img')
  image.src = picArray[i].image.medium
  image.alt = picArray[i].image.alt

  let kuvatekstielementti = document.createElement('figcaption')
  let kuvateksti = document.createTextNode(picArray[i].caption)


  let tekstielementti = document.createElement('p')
  let teksti = document.createTextNode(picArray[i].description)


  let artikkeli = document.createElement('article')


  otsikko2elementti.appendChild(otsikko2)
  artikkeli.appendChild(otsikko2elementti)
  kuvatekstielementti.appendChild(kuvateksti)
  figuuri.appendChild(image)
  figuuri.appendChild(kuvatekstielementti)
  artikkeli.appendChild(figuuri)
  tekstielementti.appendChild(teksti)
  artikkeli.appendChild(tekstielementti)
  target.appendChild(artikkeli)
}
